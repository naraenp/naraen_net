...
paper:
 ...
 venue: "Nature Reviews Genetics, 2010"
...
**Why it matters.** This is the paper you read to *place* everything else. It gives a shared vocabulary (parts / devices / systems, circuit motifs) and, more usefully for positioning, it makes clear where the advantage lies. The wet-lab construction is expensive and slow; the design, modeling, and characterization, the parts that decide *what* to build and *whether it worked*, are increasingly computational. That's the seam a data/analysis shop can own without a foundry.
